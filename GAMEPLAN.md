...
- **Notes:** dedicated OneNote-style workspace with a notebook/section rail, searchable page list, full writing canvas, quick formatting helpers, auto-save through the main account data, pinning, editing, and confirmed deletion. Existing tags act as notebook sections so older notes migrate without data changes.
